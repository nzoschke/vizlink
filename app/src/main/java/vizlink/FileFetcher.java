 ...
 *
 * <p>The primary purpose of this class is provided through the {@link #fetch(InetAddress, String, String, File, int)}
 * method.</p>
 *
...
public class FileFetcher {
     ...
     */
    @API(status = API.Status.STABLE)
    public void fetch(InetAddress player, String mountPath, String sourcePath, File destination, int size) throws IOException {
        try (FileOutputStream outputStream = new FileOutputStream(destination)) {
            ...
            while (bytesLeft > 0 && args.offset < size) {
